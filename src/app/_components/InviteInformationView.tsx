"use client"
import { ActionButton, AlertDialog, DialogTrigger, ProgressCircle, Text, View } from "@adobe/react-spectrum";
...
export function InviteInformationView({ avatarId }: {avatarId: number}) {
    const [result] = api.avatar.getInvitationUrl.useSuspenseQuery({avatarId: avatarId});
