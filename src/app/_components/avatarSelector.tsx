...
export const AvatarSelecter = ({ onAvatarSelected }: {onAvatarSelected: (selectedAvatar: Avatar | null) => void}) => {
            ...
            >
                {avatars.map((avatar) => (
                    <Radio key={avatar.id} value={avatar.id.toString()}>
                        <AvatarDisplay name={avatar.name} iconFileName={avatar.iconFileName} />
                    </Radio>
                ))}
            </RadioGroup>
        </View>
